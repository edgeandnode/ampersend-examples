...
| --------------------------------------- | ---------------------- | ---------------------------------- |
| `EXAMPLES_A2A_BUYER__AMPERSEND_API_URL` | ampersend API endpoint | `https://api.sandbox.ampersend.ai` |

## Setup

1. Visit https://app.sandbox.ampersend.ai (testnet) or https://app.ampersend.ai (production)
...
All examples default to sandbox services (testnet, rate-limited).

### A2A Service URLs

| Variable                               | Sandbox (Default)                                | Production                               |
| -------------------------------------- | ------------------------------------------------ | ---------------------------------------- |
| `EXAMPLES_A2A_BUYER__SELLER_AGENT_URL` | `https://subgraph-a2a.x402.sandbox.thegraph.com` | `https://subgraph-a2a.x402.thegraph.com` |

### Local Orchestrator URLs

| Variable                          | Sandbox (Default)                                | Production                               |
| --------------------------------- | ------------------------------------------------ | ---------------------------------------- |
| `EXAMPLES_A2A_BUYER__AGENT_URL_1` | `https://subgraph-a2a.x402.sandbox.thegraph.com` | `https://subgraph-a2a.x402.thegraph.com` |
...
| `EXAMPLE_BUYER__MCP__TARGET_SERVER_URL` | `https://subgraph-mcp.x402.sandbox.thegraph.com` | `https://subgraph-mcp.x402.thegraph.com` |
...
export EXAMPLES_A2A_BUYER__SELLER_AGENT_URL=https://subgraph-a2a.x402.sandbox.thegraph.com
export EXAMPLES_A2A_BUYER__AGENT_URL_1=https://subgraph-a2a.x402.sandbox.thegraph.com
...
This is the same across sandbox and production.

## Troubleshooting

### What happens if I don't set service URLs?

Examples default to sandbox services:

- A2A: `https://subgraph-a2a.x402.sandbox.thegraph.com`
- MCP: `https://subgraph-mcp.x402.sandbox.thegraph.com`
...
- **Testnet first** - Always test on sandbox before production

## Learn More

- [Getting Started Guide](../README.md)
- [Running MCP Proxy](./running-mcp-proxy.md)
- [ampersend Dashboard (sandbox)](https://app.sandbox.ampersend.ai)
